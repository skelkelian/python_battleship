...
class Submarine(Ship):
    def __init__(self, config_name=None):
        ...
        self.validation_flag_ship_sunk_submarine_computer = self.constants.get_constant_values('validation_flag_ship_sunk_submarine_computer')
    ...
    def get_submarine_values_player_one(self):
        submarine_values_player_one = self.battleship_config.get('main', 'submarine_player')
        return submarine_values_player_one
